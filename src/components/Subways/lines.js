...
const line1 = {
  ...
  stationsData: [
    ...
    { x: 2838, y: 4305, name: '公主坟', text: 'bottom-left', isExchange: true, to: [LINE_10] },
    ...
    { x: 3767, y: 4305, name: '复兴门', text: 'bottom-right', isExchange: true, to: [LINE_2] },
    { x: 4129, y: 4305, name: '西单', text: 'top-right', isExchange: true, to: [LINE_4] },
...
const line5 = {
  ...
  stationsData: [
    ...
    { x: 5049, y: 2453, name: '立水桥', text: 'top-left', isExchange: true, to: [LINE_13] },
