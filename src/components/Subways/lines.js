...
const line1 = {
  ...
  stationsData: [
    ...
    { x: 2836, y: 4305, name: '公主坟', text: 'bottom', isExchange: true, to: [LINE_10] },
    ...
    { x: 5049, y: 4305, name: '东单', text: 'bottom', isExchange: true, to: [LINE_5] },
    { x: 5364, y: 4305, name: '建国门', text: 'bottom', isExchange: true, to: [LINE_2] },
    { x: 5589, y: 4305, name: '永安里', text: 'top' },
    { x: 5818, y: 4305, name: '国贸', text: 'bottom', isExchange: true, to: [LINE_10] },
    { x: 6099, y: 4305, name: '大望路', text: 'bottom', isExchange: true, to: [LINE_14] },
...
const line2 = {
  ...
  stationsData: [
    ...
    { x: 5363, y: 4071, name: '朝阳门', text: 'right', isExchange: true, to: [LINE_6] },
    { x: 5363, y: 4308, name: '建国门', text: 'right', isExchange: true, to: [LINE_1] },
    { x: 5331.5, y: 4520, name: '北京站', text: 'right' },
    { x: 5049, y: 4540, name: '崇文门', text: 'top', isExchange: true, to: [LINE_5] },
    { x: 4543.5, y: 4538, name: '前门', text: 'bottom' },
    { x: 4319, y: 4538, name: '和平门', text: 'top' },
    { x: 4130, y: 4538, name: '宣武门', text: 'top', isExchange: true, to: [LINE_4] },
...
const line4 = {
  ...
  stationsData: [
    ...
    { x: 2884, y: 2559, name: '西苑', text: 'top', isExchange: true, to: [LINE_16] },
    { x: 3070, y: 2713, name: '圆明园', text: 'right' },
    { x: 3070, y: 2862, name: '北京大学东门', text: 'left' },
    { x: 3070, y: 3001, name: '中关村', text: 'right' },
    { x: 3070, y: 3190, name: '海淀黄庄', text: 'right', isExchange: true, to: [LINE_10] },
    { x: 3070, y: 3393, name: '人民大学', text: 'right' },
    { x: 3070, y: 3564, name: '魏公村', text: 'left' },
    { x: 3080, y: 3698, name: '国家图书馆', text: 'left', isExchange: true, to: [LINE_9] },
    ...
    { x: 4129, y: 4538, name: '宣武门', text: 'left', isExchange: true, to: [LINE_2] },
    { x: 4129, y: 4683, name: '菜市口', text: 'left', isExchange: true, to: [LINE_7] },
    { x: 4129, y: 4852, name: '陶然亭', text: 'right' },
    { x: 4129, y: 4998, name: '北京南站', text: 'left', isExchange: true, to: [LINE_4] },
    { x: 4129, y: 5170, name: '马家堡', text: 'left' },
    { x: 4129, y: 5348, name: '角门西', text: 'left', isExchange: true, to: [LINE_10] },
    { x: 4129, y: 5469, name: '公益西桥', text: 'left' },
    { x: 4129, y: 5578, name: '新宫', text: 'right' },
...
const line5 = {
  ...
  stationsData: [
    ...
    { x: 5049, y: 2908.5, name: '大屯路东', text: 'right', isExchange: true, to: [LINE_15] },
    { x: 5049, y: 3060, name: '惠新西街北口', text: 'right' },
    { x: 5049, y: 3192, name: '惠新西街南口', text: 'right', isExchange: true, to: [LINE_10] },
    { x: 5049, y: 3361, name: '和平西桥', text: 'right' },
    { x: 5049, y: 3477, name: '和平里北街', text: 'right' },
    { x: 5049, y: 3590, name: '雍和宫', text: 'left', isExchange: true, to: [LINE_2] },
    { x: 5049, y: 3774.5, name: '北新桥', text: 'right' },
    { x: 5049, y: 3901.5, name: '张自忠路', text: 'right' },
    { x: 5049, y: 4071, name: '东四', text: 'right', isExchange: true, to: [LINE_6] },
    { x: 5049, y: 4185.5, name: '灯市口', text: 'right' },
    { x: 5049, y: 4307, name: '东单', text: 'right', isExchange: true, to: [LINE_1] },
    { x: 5049, y: 4540, name: '崇文门', text: 'top', isExchange: true, to: [LINE_2] },
    { x: 5049, y: 4684, name: '磁器口', text: 'left', isExchange: true, to: [LINE_7] },
    { x: 5049, y: 4839, name: '天坛东门', text: 'right' },
    { x: 5049, y: 4995, name: '蒲黄榆', text: 'bottom', isExchange: true, to: [LINE_14] },
    { x: 5049, y: 5168, name: '刘家窑', text: 'left' },
    { x: 5049, y: 5347, name: '宋家庄', text: 'right', isExchange: true, to: [LINE_10] }
  ]
}
...
const line7 = {
  ...
  stationsData: [
    ...
    { x: 4124, y: 4680, name: '菜市口', text: 'bottom-left', isExchange: true, to: [LINE_4] },
    { x: 4348, y: 4680, name: '虎坊桥', text: 'bottom' },
    { x: 4555, y: 4680, name: '珠市口', text: 'bottom' },
    { x: 4805, y: 4680, name: '桥湾', text: 'top' },
    { x: 5052, y: 4680, name: '磁器口', text: 'bottom-left', isExchange: true, to: [LINE_5] },
    { x: 5268, y: 4680, name: '广渠门内', text: 'top' },
    { x: 5472, y: 4680, name: '广渠门外', text: 'bottom' },
    { x: 5816, y: 4680, name: '双井', text: 'top-left', isExchange: true, to: [LINE_10] },
    { x: 6092, y: 4680, name: '九龙山', text: 'top-left', isExchange: true, to: [LINE_14] },
...
const line9 = {
  ...
  color: '#66b82f',
  stationsData: [
    { x: 3076, y: 3700, name: '国家图书馆', text: 'bottom-left', isExchange: true, to: [LINE_4] },
    ...
    { x: 2832, y: 4640, name: '六里桥', text: 'top-left', isExchange: true, to: [LINE_10] },
...
const line10 = {
  name: LINE_10,
  d: `M5050 5345 H5500 C5755 5345, 5818 5240, 5818 5141 V3312
  ...
  color: '#018cac',
  stationsData: [
    { x: 5050, y: 5345, name: '宋家庄', text: 'right', isExchange: true, to: [LINE_5, LINE_YIZHUANG] },
    { x: 5484, y: 5345, name: '成寿寺', text: 'top' },
    { x: 5762, y: 5276, name: '分钟寺', text: 'right' },
    { x: 5818, y: 4993, name: '十里河', text: 'left', isExchange: true, to: [LINE_14] },
    { x: 5818, y: 4874, name: '潘家园', tetx: 'left' },
    ...
    { x: 5818, y: 3390, name: '三元桥', text: 'right' },
    { x: 5772, y: 3220, name: '太阳宫', text: 'left' },
    ...
    { x: 3653, y: 3190, name: '知春路', text: 'left', isExchange: true, to: [LINE_13] },
    { x: 3257, y: 3190, name: '知春里', text: 'bottom' },
    { x: 3069, y: 3190, name: '海淀黄庄', text: 'left', isExchange: true, to: [LINE_4] },
    ...
    { x: 2838, y: 4640, name: '六里桥', text: 'left', isExchange: true, to: [LINE_9] },
    { x: 2838, y: 4934, name: '西局', text: 'right', isExchange: true, to: [LINE_14] },
    ...
    { x: 4130, y: 5348, name: '角门西', text: 'left', isExchange: true, to: [LINE_4] },
...
const line13 = {
  ...
  stationsData: [
    ...
    { x: 3654, y: 3191, name: '知春路', text: 'left', isExchange: true, to: [LINE_10] },
    ...
    { x: 5452, y: 3191, name: '芍药居', text: 'right', isExchange: true, to: [LINE_10] },
...
const line14 = {
  ...
  stationsData: [
    ...
    { x: 2700, y: 4937, name: '七里庄', text: 'bottom', isExchange: true, to: [LINE_9] },
    { x: 2834, y: 4937, name: '西局', text: 'right', isExchange: true, to: [LINE_10] },
    { x: 4127, y: 4995, name: '北京南站', text: 'left', isExchange: true, to: [LINE_4] },
    { x: 4338, y: 4995, name: '陶然桥', text: 'bottom', notOpened: true },
    { x: 4577.5, y: 4995, name: '永定门外', text: 'top' },
    { x: 4796, y: 4995, name: '景泰', text: 'top' },
    { x: 5049, y: 4995, name: '蒲黄榆', text: 'bottom', isExchange: true, to: [LINE_5] },
    { x: 5449, y: 4995, name: '方庄', text: 'bottom' },
    { x: 5817, y: 4995, name: '十里河', text: 'bottom', isExchange: true, to: [LINE_10] },
    { x: 5984, y: 4995, name: '北工大西门', text: 'bottom' },
    { x: 6100, y: 4832, name: '平乐园', text: 'left', notOpened: true },
    { x: 6100, y: 4682, name: '九龙山', text: 'bottom', isExchange: true, to: [LINE_7] },
    { x: 6100, y: 4307, name: '大望路', text: 'bottom', isExchange: true, to: [LINE_1] },
    { x: 6100, y: 4071, name: '金台路', text: 'bottom', isExchange: true, to: [LINE_6] },
    ...
    { x: 6031, y: 3175.5, name: '望京南', text: 'right' },
    { x: 5923, y: 3057, name: '阜通', text: 'right' },
    { x: 5872, y: 2908.5, name: '望京', text: 'right', isExchange: true, to: [LINE_15] },
...
const line16 = {
  ...
  stationsData: [
    ...
    { x: 2884, y: 2556, name: '西苑', text: 'left', isExchange: true, to: [LINE_4] }
  ]
}
...
const airportExpress = {
  ...
  stationsData: [
    ...
    { x: 5815.5, y: 3391.5, name: '三元桥', text: 'left', isExchange: true, to: [LINE_10] },
...
const lineYiZhuang = {
  ...
  color: '#DC1773',
  stationsData: [
     { x: 5048.5, y: 5345.5, name: '宋家庄', text: 'bottom-right', isExchange: true, to: [LINE_8, LINE_10] },
...
const lineFangShan = {
  ...
  color: '#D85F34',
  stationsData: [
     { x: 2694, y: 5634, name: '郭公庄', text: 'right', isExchange: true, to: [LINE_9] },
